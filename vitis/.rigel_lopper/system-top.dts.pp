...
/ {
	cpus_microblaze_riscv_0: cpus_microblaze_riscv@0 {
		...
		microblaze_riscv_0: cpu@0 {
			...
			xlnx,use-icache = <1>;
			d-cache-size = <8192>;
			xlnx,memory-ip-list = "microblaze_riscv_0_local_memory_dlmb_bram_if_cntlr_memory" , "microblaze_riscv_0_local_memory_ilmb_bram_if_cntlr_memory" , "mig_7series_0_memory" , "mig_7series_0_memory" , "gpu_axi_bram_ctrl_0_memory";
			xlnx,async-wakeup = <3>;
	...
	amba_pl: amba_pl {
		...
		microblaze_riscv_0_axi_intc: interrupt-controller@41200000 {
			...
			xlnx,processor-clk-freq-mhz = <200>;
			status = "okay";
			xlnx,is-fast = <0x1>;
			xlnx,has-fast = <1>;
		...
		gpu_axi_bram_ctrl_0: axi_bram_ctrl@c0000000 {
			xlnx,protocol = "AXI4";
...
/ {
	...
	gpu_axi_bram_ctrl_0_memory: memory@c0000000 {
		compatible = "xlnx,axi-bram-ctrl-4.1";
		xlnx,ip-name = "axi_bram_ctrl";
		device_type = "memory";
		memory_type = "memory";
	...
	cpus_microblaze_riscv_0: cpus_microblaze_riscv@0 {
		address-map = <0xC0000000 &gpu_axi_bram_ctrl_0_memory 0xC0000000 0x20000>,
			      <0xC0000000 &gpu_axi_bram_ctrl_0 0xC0000000 0x20000>,
