...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "H_WHOLE_LINE_PXL" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "V_WHOE_FRAME_PXL" -parent ${Page_0}
...
proc update_PARAM_VALUE.H_WHOLE_LINE_PXL { PARAM_VALUE.H_WHOLE_LINE_PXL } {
	# Procedure called to update H_WHOLE_LINE_PXL when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.H_WHOLE_LINE_PXL { PARAM_VALUE.H_WHOLE_LINE_PXL } {
	# Procedure called to validate H_WHOLE_LINE_PXL
	return true
}
...
proc update_PARAM_VALUE.V_WHOE_FRAME_PXL { PARAM_VALUE.V_WHOE_FRAME_PXL } {
	# Procedure called to update V_WHOE_FRAME_PXL when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.V_WHOE_FRAME_PXL { PARAM_VALUE.V_WHOE_FRAME_PXL } {
	# Procedure called to validate V_WHOE_FRAME_PXL
	return true
}
...
proc update_MODELPARAM_VALUE.H_WHOLE_LINE_PXL { MODELPARAM_VALUE.H_WHOLE_LINE_PXL PARAM_VALUE.H_WHOLE_LINE_PXL } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.H_WHOLE_LINE_PXL}] ${MODELPARAM_VALUE.H_WHOLE_LINE_PXL}
}
...
proc update_MODELPARAM_VALUE.V_WHOE_FRAME_PXL { MODELPARAM_VALUE.V_WHOE_FRAME_PXL PARAM_VALUE.V_WHOE_FRAME_PXL } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.V_WHOE_FRAME_PXL}] ${MODELPARAM_VALUE.V_WHOE_FRAME_PXL}
}
