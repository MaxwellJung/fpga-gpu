...
.section .text
main:
    li x8, 4096 # palette base addr
    la x1, rgb332_palette # rgb334 addr
    li x2, 0 # palette index
    li x3, 256 # palette size

write_palette:
    slli x5, x2, 2
    add x6, x1, x5
    lw x7, 0(x6)
    add x4, x8, x2 # palette addr
    sw x7, 0(x4)
    addi x2, x2, 1
    blt x2, x3, write_palette
