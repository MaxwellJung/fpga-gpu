# write to address
create_hw_axi_txn -force write_txn [get_hw_axis hw_axi_1] -type write -address C000_0008 -len 3 -data {00000000_00FF0000_00000001}
run_hw_axi [get_hw_axi_txns write_txn]
create_hw_axi_txn -force read_txn [get_hw_axis hw_axi_1] -type read -address C000_0008 -len 3
run_hw_axi [get_hw_axi_txns read_txn]

create_hw_axi_txn -force write_txn [get_hw_axis hw_axi_1] -type write -address C000_0014 -len 3 -data {00000000_0000001C_00000009}
run_hw_axi [get_hw_axi_txns write_txn]
